...
//             <MdKeyboardArrowRight size={'25px'} className='text-[#06286E]' />
...
//     <li className="me-2">
//     <p aria-current="page" className="inline-block p-4 text-[#06286E] border-b-2 border-blue-900 rounded-t-lg active  text-xl font-bold  cursor-pointer" href="#" > Study</p>
//     </li>
//     <li className="me-2">
//      <p className="inline-block p-4 border-b-2 border-transparent rounded-t-lg text-[#696671]  hover:text-[#06286E] hover:border-blue-900 text-xl font-medium cursor-pointer" href="#"> Quiz</p>
//     </li>
//     <li className="me-2">
//       <p className="inline-block p-4 border-b-2 border-transparent rounded-t-lg text-[#696671] hover:text-[#06286E] hover:border-blue-900 text-xl font-medium cursor-pointer" href="#" >Test</p>
//     </li>
//     <li className="me-2">
//       <p className="inline-block p-4 border-b-2 border-transparent rounded-t-lg text-[#696671] hover:text-[#06286E] hover:border-blue-900 text-xl font-medium cursor-pointer" href="#" >Game</p>
//     </li>
//     <li className="me-2">
//       <p className="inline-block p-4 border-b-2 border-transparent rounded-t-lg text-[#696671] hover:text-[#06286E] hover:border-blue-900 text-xl font-medium cursor-pointer" href="#" > Others </p>
//     </li>
...
//       <img src={speaker} alt='' />
//     </div>
//     <p className='mt-[150px] text-center font-bold text-3xl text-white'>9 + 6 + 7x - 2x - 3</p>
//   </div>
...
//       <p className='text-[#202B37] font-bold text-2xl'>01/10</p>
...
//       <img src={Hyggex} alt='Hyggex' className='-ml-8' />
//       <div className='flex items-center gap-4 mt-4 sm:mt-0'>
//       <img src={Plus} alt='Plus' />
//       <p className='text-2xl font-semibold' style={{background: 'linear-gradient(180deg, #06286E 0%, #164EC0 100%)',WebkitBackgroundClip: 'text',WebkitTextFillColor: 'transparent' }}>Create Flashcard</p>
//       </div>
//     </div>
...
const Middle = () => {
  ...
  <div className='flex justify-between items-center w-[90%]'>
    <img src={Reload} alt='Reload' className='w-[20px] sm:w-[30px]' />
    <div className='flex justify-between items-center gap-2 sm:gap-8'>
      <img src={Left} alt='Left' className='w-[20px] sm:w-[60px]' />
      <p className='text-[#202B37] font-bold text-sm sm:text-2xl'>01/10</p>
      <img src={Right} alt='Right' className='w-[20px] sm:w-[60px]' />
    </div>
    <img src={Zoom} alt='Zoom' className='w-[20px] sm:w-[30px]' />
   </div>
   </div>
